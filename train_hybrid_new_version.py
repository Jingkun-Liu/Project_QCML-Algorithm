...
# # 修改数据预处理部分（原代码需要修改）
# # 原始数据分割为训练和测试
# train_size = int(len(features) * 0.8)  # 先按原始数据分割
# train_features = features[:train_size]
# test_features = features[train_size:]

# ETTh1/2
# flag = int(len(features) * 0.75)
# train_size1 = int(len(features) * 0.2) # 先按原始数据分割
# train_size2 = int(train_size1 * 0.75)
# train_features= features [flag : (flag + train_size2)]
# validation_features = features  [(flag + train_size2) : (flag + train_size1)]
# test_features = features[(flag + train_size1) : ]

# ETTm1/2
# flag = int(len(features) * (11/12))
# train_size1 = int(len(features) * (1/15)) # 先按原始数据分割
# train_size2 = int(train_size1 * 0.75)
# train_features= features [flag : (flag + train_size2)]
# val_features = features  [(flag + train_size2) : (flag + train_size1)]
# test_features = features[(flag + train_size1) : ]

# illness
train_size1 = int(len(features) * 0.6) # 先按原始数据分割
...
optimizer.maximize(init_points=5, n_iter=10) # 5个随机采样点，10个定向搜索
...
# print(f'The shape of inv_preds is {inv_preds.shape}')
# print(f'The shape of inv_actuals is {inv_actuals.shape}')
